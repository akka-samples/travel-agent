...
class TravelPlannerEndpointIntegrationTest extends TestKitSupport {
  ...
  protected TestKit.Settings testKitSettings() {
    return TestKit.Settings.DEFAULT.withModelProvider(TravelPlannerAgent.class, agentModel);
  }
  ...
  void shouldReturn404ForNonExistentTrip() {
    var response = httpClient.GET("/travel-planner/trips/non-existent-trip-id").invoke();
